...
| `--str-chat__message-border-inline-start`            | Right (lrft in RTL layout) border of the component                                                         |
...
| `--str-chat__message-options-active-color`           | The icon color used for displaying message options in pressed state                                        |
...
| `--str-chat__message-bubble-border-inline-start`     | Right (lrft in RTL layout) border of the message bubble                                                    |
...
| `--str-chat__deleted-message-border-inline-start`    | Right (lrft in RTL layout) border of a deleted message                                                     |
...
| `--str-chat__system-message-border-inline-start`     | Right (lrft in RTL layout) border of a system message                                                      |
...
| `--str-chat__message-actions-box-border-inline-start`      | Right (lrft in RTL layout) border of the component                           |
...
| `--str-chat__message-actions-box-item-border-inline-start` | Right (lrft in RTL layout) border of an item in the message actions box      |
...
| `--str-chat__attachment-list-border-inline-start`          | Right (lrft in RTL layout) border of the component                  |
...
| `--str-chat__image-attachment-border-inline-start`         | Right (lrft in RTL layout) border of image attachments              |
...
| `--str-chat__image-gallery-attachment-border-inline-start` | Right (lrft in RTL layout) border of image gallery attachments      |
| `--str-chat__image-gallery-attachment-box-shadow`          | Box shadow applied to image gallery attachments                     |
...
| `--str-chat__card-attachment-border-inline-start`          | Right (lrft in RTL layout) border of card attachments               |
...
| `--str-chat__file-attachment-border-inline-start`          | Right (lrft in RTL layout) border of file attachments               |
...
| `--str-chat__attachment-actions-border-inline-start`       | Right (lrft in RTL layout) border of attachment actions             |
...
| `--str-chat__attachment-action-border-inline-start`        | Right (lrft in RTL layout) border of an attachment action           |
...
| `--str-chat__message-reactions-border-inline-start` | Right (lrft in RTL layout) border of the component                                 |
...
| `--str-chat__message-reaction-border-inline-start`  | Right (lrft in RTL layout) border of a message reaction                            |
...
| `--str-chat__message-reactions-options-border-inline-start`       | Right (lrft in RTL layout) border of the component           |
...
| `--str-chat__message-reactions-options-border-inline-start`       | Right (lrft in RTL layout) border of a message reaction      |
...
| `--str-chat__autocomplete-menu-border-inline-start`      | Right (lrft in RTL layout) border of the component                                        |
...
| `--str-chat__slash-command-border-inline-start`          | Right (lrft in RTL layout) border of the slash command item in the autocomplete list      |
...
| `--str-chat__mention-list-user-item-border-inline-start` | Right (lrft in RTL layout) border of the user mention item in the autocomplete list       |
...
| `--str-chat__modal-border-inline-start`     | Right (lrft in RTL layout) border of the content area of the component                                           |
...
| `--str-chat__edit-message-modal-button-border-inline-start` | Right (lrft in RTL layout) border of the modal buttons      |
