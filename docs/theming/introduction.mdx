...
```scss
// Use default theme for channel list and channel preview components
@import '~stream-chat-react/dist/scss/ChannelList/ChannelList-layout.scss';
@import '~stream-chat-react/dist/scss/ChannelList/ChannelList-theme.scss';
@import '~stream-chat-react/dist/scss/ChannelPreview/ChannelPreview-layout.scss';
@import '~stream-chat-react/dist/scss/ChannelPreview/ChannelPreview-theme.scss';
```
...
```scss
@import '~stream-chat-react/dist/scss/index.layout.scss';
```
...
```css
@import '~stream-chat-react/dist/css/index.layout.css';
```
